...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_113_DSP.html'
...
COURSE_DATA = {
    ...
    "semester": "2024 Fall (113學年度上學期)",
    "tag": "電機專",
    "time_loc": "Mabc @ 工程五館 105 室 (EE105)",
    ...
    "tas": [ # 助教名單
        {"name": "陳韋澎", "email": "richardtang.ii11@nycu.edu.tw"},
        {"name": "孫健文", "email": "cwsun.ee12@nycu.edu.tw"},
    ],
    "ta_office": "工程五館 618 室 (分機 54421)",
    "announcements": [ # 公告內容
        {"date": "2024/10/21", "title": "期中考 (Midterm Exam)"},
        {"date": "2024/12/30", "title": "期末考 (Final Exam)"},
        {"date": "2024/01/06", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2024/01/07", "title": "學期成績公佈 (Final Grade Post)"},
        {"date": "置頂", "title": "簽到注意事項", "note": "由於校方作業需要，請學分班的同學每堂課都要簽到。"},
    ],
    "homeworks": [ # 作業列表
        {"title": "HW 1", "due": "2024/09/23", "note": "請登入學校 e3 收信"},
        {"title": "HW 2", "due": "2024/09/30", "note": "請登入學校 e3 收信"},
        {"title": "HW 3", "due": "2024/10/07", "note": "請登入學校 e3 收信"},
        {"title": "HW 4", "due": "2024/10/14", "note": "請登入學校 e3 收信"},
        {"title": "HW 5", "due": "2024/11/04", "note": "請登入學校 e3 收信"},
        {"title": "HW 6", "due": "2024/11/11", "note": "請登入學校 e3 收信"},
        {"title": "HW 7", "due": "2024/12/03", "note": "請登入學校 e3 收信"},
    ],
}
