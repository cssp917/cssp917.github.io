...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_113_CSD.html'
...
COURSE_DATA = {
    ...
    "semester": "2025 Spring (113學年度下學期)",
    ...
    "announcements": [
        ...
        {"date": "2024/04/30", "title": "期中考 (2nd Midterm Exam)"},
        {"date": "2024/06/04", "title": "期末考 (Final Exam)"},
        {"date": "2024/06/11", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2024/06/12", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [
        {"title": "HW 1", "due": "2024/03/10"},
        {"title": "HW 2", "due": "2024/03/19"},
        {"title": "HW 3", "due": "2024/04/03"},
        {"title": "HW 4", "due": "2024/04/09"},
        {"title": "HW 5", "due": "2024/04/21"},
        {"title": "HW 6", "due": "2024/04/28"},
    ],
    "quizzes": [
    ]
}
...
def _render_grid_items(items, icon_name, color_class="text-primary"):
    ...
    """
    if not items:
        return '<p class="text-muted"><i class="fas fa-info-circle mr-2"></i>本學年無小考。</p>'
