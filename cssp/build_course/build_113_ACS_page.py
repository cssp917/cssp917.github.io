...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_113_ACS.html'
...
COURSE_DATA = {
    ...
    "announcements": [ # 公告內容
        {"date": "2024/10/23", "title": "期中考 (Midterm Exam)"},
        {"date": "2024/12/18", "title": "期末考 (Final Exam)"},
        {"date": "2024/12/25", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2024/12/26", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [ # 作業列表
        {"title": "HW 1", "due": "2024/10/23"},
        {"title": "HW 2", "due": "2024/11/06"},
        {"title": "HW 3", "due": "2024/11/13"},
        {"title": "HW 4", "due": "2024/11/20"},
    ],
    "quizzes": [ # 小考列表
        {"title": "Quiz 1", "date": "2024/09/18"},
        {"title": "Quiz 2", "date": "2024/09/24"},
        {"title": "Quiz 3", "date": "2024/09/26"},
        {"title": "Quiz 4", "date": "2024/10/07"},
        {"title": "Quiz 5", "date": "2024/10/14"},
        {"title": "Quiz 6", "date": "2024/11/06"},
        {"title": "Quiz 7", "date": "2024/11/13"},
        {"title": "Quiz 8", "date": "2024/11/18"},
        {"title": "Quiz 9", "date": "2024/12/02"},    
        {"title": "Quiz 10", "date": "2024/12/11"},    
        ]
}
