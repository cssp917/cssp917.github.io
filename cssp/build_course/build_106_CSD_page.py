...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_106_CSD.html'

# --- 課程資料來源 ---
# 包含課程的所有資訊，結構類似 JSON，方便日後替換成資料庫讀取
COURSE_DATA = {
    "title_zh": "控制系統設計",
    "title_en": "Control Systems Design",
    "semester": "2018 Spring (106學年度下學期)",
    "tag": "電機系", # 對應 TAG_STYLE_MAP
    "time_loc": "Mon 9:00 - 9:50 & Wed 10:10 - 12:00 @ 工程五館 623 室 (EE623)",
    "prerequisites": "訊號與系統、線性代數",
    "textbooks": [
        "F. Golnaraghi and B. C. Kuo, <i>Automatic Control Systems</i>, 10th ed. McGraw-Hill Education, 2017."
    ],
    "files": [ # 講義與作業檔案
        {"title": "Project (密碼:NCTUCSSP)", "url": "106_courseCSD/Project.pptx", "note": "PPT"},
        {"title": "3/21 課文補充(1)", "url": "106_courseCSD/p57.pdf", "note": "PDF"},
        {"title": "3/21 課文補充(2)", "url": "106_courseCSD/p68.pdf", "note": "PDF"},
        {"title": "HW 1 & Solution", "url": "106_courseCSD/CSD 2018 Homework 1.doc", "note": "Word"},
        {"title": "HW 2", "url": "106_courseCSD/CSD 2018 Homework 2.doc", "note": "Word"},
        {"title": "HW 3", "url": "106_courseCSD/CSD 2018 Homework 3.doc", "note": "Word"},
        {"title": "HW 4", "url": "106_courseCSD/CSD 2018 Homework 4.doc", "note": "Word"},
    ], 
    "resources": [], # 目前資料無外部連結，留空以維持結構
    "grading": [ # 評分標準與權重
        {"item": "作業 (Homework)", "percent": 10, "note": "兩次(含)零分，此部分以零分計"},
        {"item": "創意專題 (Project)", "percent": 50, "note": ""},
        {"item": "期中考 (Midterm)", "percent": 20, "note": ""},
        {"item": "期末考 (Final)", "percent": 20, "note": ""}
    ],
    "office_hours": {
        "teacher": "Wed. 13:30 - 15:30 at EE773",
        "ta": "Thu. 19:00 - 21:00 at EE917 or EE618"
    },
    "tas": [ # 助教名單
        {"name": "梁家維", "email": "winnieflute.cv94@g2.nctu.edu.tw"},
        {"name": "黃至正", "email": "cheng0211@cssp.cn.nctu.edu.tw"},
        {"name": "吳秉璋", "email": "peter6179@cssp.cn.nctu.edu.tw"},
        {"name": "吳宜樵", "email": "joiewu@cssp.cn.nctu.edu.tw"},
        {"name": "魏胤哲", "email": "yintse@cssp.cn.nctu.edu.tw"},
        {"name": "蔡尹晟", "email": "adison1217@cssp.cn.nctu.edu.tw"}
    ],
    "ta_office": "工程五館 917 室 (分機 54428) / 618 室 (分機 54421)",
    "announcements": [ # 公告內容
        {"date": "2018/04/11", "title": "期中考 (Midterm Exam)", "note": "10:10~12:40 @ EE207 & EE208"},
        {"date": "2018/06/20", "title": "期末考 (Final Exam)", "note": "10:10~12:40"},
        {"date": "2018/06/27", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2018/06/28", "title": "專題報告 (Project Report)", "note": "Deadline"},
        {"date": "2018/06/29", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [ # 作業列表 (原始網頁無具體截止日期，僅列出項目)
        {"title": "HW 1", "due": ""},
        {"title": "HW 2", "due": ""},
        {"title": "HW 3", "due": ""},
        {"title": "HW 4", "due": ""},
