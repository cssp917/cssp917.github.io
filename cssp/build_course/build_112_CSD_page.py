...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_112_CSD.html'
...
COURSE_DATA = {
    ...
    "semester": "2024 Spring (112學年度下學期)",
    ...
    "tas": [
        ...
        {"name": "劉郁昇", "email": "caleb092310.ee12@nycu.edu.tw"},
        {"name": "陳韋澎", "email": "richardtang.ii11@nycu.edu.tw"}
    ],
    "ta_office": "工程五館 917 室 (分機 54428)",
    "announcements": [
        {"date": "2024/04/17", "title": "期中考 (Midterm Exam)"},
        {"date": "2024/06/05", "title": "期末考 (Final Exam)"},
        {"date": "2024/06/12", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2024/06/13", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [
        {"title": "HW 1", "due": "2024/03/06"},
        {"title": "HW 2", "due": "2024/03/20"},
        {"title": "HW 3", "due": "2024/04/25"},
        {"title": "HW 4", "due": "2024/05/01"},
    ],
    "quizzes": [
        {"title": "Quiz 1", "date": "2024/03/11"},
        {"title": "Quiz 2", "date": "2024/03/13"},
        {"title": "Quiz 3", "date": "2024/04/24"},
        {"title": "Quiz 4", "date": "2024/04/29"},
        {"title": "Quiz 5", "date": "2024/05/13"},
        {"title": "Quiz 6", "date": "2024/05/20"},
    ],
}
