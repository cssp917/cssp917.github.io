...
# 輸出檔案路徑 
FILENAME = 'assets/html/course/course_111_ACS.html'
...
COURSE_DATA = {
    ...
    "files": [ # 供下載的檔案列表
        {"title": "111上自動控制注意事項", "url": "", "note": "2022/09/13"},
    ],
    "resources": [ # 外部連結列表
    ],
    "grading": [ # 評分標準與權重
    ...
    "tas": [ # 助教名單
        {"name": "林瑞奕", "email": "linkv203@cssp.cn.nctu.edu.tw"},
        {"name": "曾致崴", "email": "chihwei@cssp.cn.nctu.edu.tw"},
        {"name": "李炳鴻", "email": "stu950065@cssp.cn.nctu.edu.tw"}
    ],
    "ta_office": "工程五館 917 室 (分機 54428)",
    "announcements": [ # 公告內容
        {"date": "2022/11/09", "title": "期中考 (Midterm Exam)", "note": "10:00~13:00 @ EE102 / EE132"},
        {"date": "2022/12/28", "title": "期末考 (Final Exam)", "note": "10:10~12:40 @ EE102 / EE132"},
        {"date": "2023/01/04", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2023/01/05", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [ # 作業列表
        {"title": "HW 1", "due": "2022/11/01"},
        {"title": "HW 2", "due": "2022/12/08"},
        {"title": "HW 3", "due": "2022/12/15"},
        {"title": "HW 4", "due": "2022/12/22"},
    ],
    "quizzes": [ # 小考列表
        {"title": "Quiz 1", "date": "2022/09/29"},
        {"title": "Quiz 2", "date": "2022/10/04"},
        {"title": "Quiz 3", "date": "2022/10/13"},
        {"title": "Quiz 4", "date": "2022/10/20"},
        {"title": "Quiz 5", "date": "2022/11/15"},
        {"title": "Quiz 6", "date": "2022/11/25"},
        {"title": "Quiz 7", "date": "2022/11/29"},
        {"title": "Quiz 8", "date": "2022/12/06"},
        {"title": "Quiz 9", "date": "2022/12/20"},
        {"title": "Quiz 10", "date": "2022/12/26"},
    ]
}
