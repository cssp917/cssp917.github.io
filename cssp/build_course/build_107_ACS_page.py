...
# 輸出檔案路徑 (更新為 107 學年度)
FILENAME = 'assets/html/course/course_107_ACS.html'

# --- 課程資料來源 (更新為 107 學年度資料) ---
COURSE_DATA = {
    "title_zh": "自動控制系統",
    "title_en": "Automatic Control Systems",
    "semester": "2018 Fall (一百零七學年度上學期)",
    "tag": "電機系", # 對應 TAG_STYLE_MAP
    "time_loc": "Tues. 9:00 - 9:50 & Thur. 10:10 - 12:00 @ 工程五館 623 室 (EE623)",
    ...
    "resources": [ # 外部連結列表
        {"title": "成績查詢與解答系統", "url": "#", "desc": "Grade Inquiry System"},
        {"title": "MATLAB 線上教學", "url": "https://www.mathworks.com/support/learn-with-matlab-tutorials.html", "desc": "Official Tutorials"}
    ],
    "grading": [ # 評分標準與權重
    ...
    "office_hours": {
        "teacher": "Wed. 19:00 - 21:00 at EE773",
        "ta": "Thu. 19:00 - 21:00 at EE917"
    },
    "tas": [ # 助教名單
        {"name": "郜漢光", "email": "h013930@cssp.cn.nctu.edu.tw"},
        {"name": "蔡秉叡", "email": "j92453@cssp.cn.nctu.edu.tw"},
        {"name": "何達弘", "email": "allendhhe@cssp.cn.nctu.edu.tw"},
        {"name": "林均翰", "email": "student011141@cssp.cn.nctu.edu.tw"}
    ],
    "ta_office": "工程五館 917 室 (分機 54428)",
    "announcements": [ # 公告內容
        {"date": "2018/11/08", "title": "期中考 (Midterm Exam)", "note": "10:00~13:00 @ EE102 / EE132"},
        {"date": "2019/01/10", "title": "期末考 (Final Exam)", "note": "10:10~12:40 @ EE102 / EE132"},
        {"date": "2019/01/17", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2019/01/18", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [ # 作業列表
        {"title": "HW 1"}, {"title": "HW 2"}, {"title": "HW 3"},
        {"title": "HW 4"}, {"title": "HW 5"}, {"title": "HW 6"}
    ],
    "quizzes": [ # 小考列表
        {"title": "Quiz 1"}, {"title": "Quiz 2"}, {"title": "Quiz 3"}, {"title": "Quiz 4"},
        {"title": "Quiz 5"}, {"title": "Quiz 6"}, {"title": "Quiz 7"}, {"title": "Quiz 8"},
        {"title": "Quiz 9"}, {"title": "Quiz 10"}
    ]
}
