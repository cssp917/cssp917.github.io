...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_112_ACS.html'
...
COURSE_DATA = {
    ...
    "files": [ # 供下載的檔案列表
        {"title": "Breakaway point Supplement", "url": "", "note": "2023/12/04"},
    ],
    "resources": [ # 外部連結列表
    ], 
    "grading": [ # 評分標準與權重
    ...
    "office_hours": {
        "teacher": "Tue. 19:00 - 21:00 at EE773",
        "ta": "Wed. 19:00 - 21:00 at EE917"
    },
    "tas": [ # 助教名單
        {"name": "孫健文", "email": "cwsun.ee12@nycu.edu.tw"},
        {"name": "林宥成", "email": "daniel.en12@nycu.edu.tw"},
        {"name": "陳韋澎", "email": "richardtang.ii11@nycu.edu.tw"}
    ],
    "ta_office": "工程五館 917 室 (分機 54428)",
    "announcements": [ # 公告內容
        {"date": "2023/11/01", "title": "期中考 (Midterm Exam)"},
        {"date": "2023/12/27", "title": "期末考 (Final Exam)"},
        {"date": "2024/01/03", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2024/01/04", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [ # 作業列表
        {"title": "HW 1", "due": "2023/11/15"},
        {"title": "HW 2", "due": "2023/11/29"},
        {"title": "HW 3", "due": "2023/12/06"},
        {"title": "HW 4", "due": "2023/12/12"},
    ],
    "quizzes": [ # 小考列表
        {"title": "Quiz 1", "date": "2023/09/28"},
        {"title": "Quiz 2", "date": "2023/10/04"},
        {"title": "Quiz 3", "date": "2023/10/12"},
        {"title": "Quiz 4", "date": "2023/10/16"},
        {"title": "Quiz 5", "date": "2023/10/23"},
        {"title": "Quiz 6", "date": "2023/11/20"},
        {"title": "Quiz 7", "date": "2023/11/22"},
        {"title": "Quiz 8", "date": "2023/12/04"},
        {"title": "Quiz 9", "date": "2023/12/26"},    ]
}
