...
# 輸出檔案路徑
FILENAME = 'assets/html/course/course_111_CSD.html'
...
COURSE_DATA = {
    ...
    "semester": "2023 Spring (111學年度下學期)",
    ...
    "grading": [ # 評分標準與權重
        ...
        {"item": "小考 (Quiz)", "percent": 30, "note": "兩次(含)零分，此部分以零分計"},
    ...
    "announcements": [ # 公告內容
        {"date": "2023/04/12", "title": "期中考 (Midterm Exam)"},
        {"date": "2023/05/31", "title": "期末考 (Final Exam)"},
        {"date": "2023/06/07", "title": "原始成績公佈 (Raw Grade Post)"},
        {"date": "2023/06/08", "title": "學期成績公佈 (Final Grade Post)"},
    ],
    "homeworks": [ # 作業列表
        {"title": "HW 1", "due": "2023/03/16"},
        {"title": "HW 2", "due": "2023/03/29"},
        {"title": "HW 3", "due": "2023/04/10"},
        {"title": "HW 4", "due": "2023/04/20"},
        {"title": "HW 5", "due": "2023/05/10"},
        {"title": "HW 6", "due": "2023/05/24"},
        {"title": "HW 7", "due": "2023/05/25"},
    ],
    "quizzes": [ # 小考列表
        {"title": "Quiz 1", "date": "2023/03/11"},
        {"title": "Quiz 2", "date": "2023/03/13"},
        {"title": "Quiz 3", "date": "2023/04/24"},
        {"title": "Quiz 4", "date": "2023/04/29"},
        {"title": "Quiz 5", "date": "2023/05/13"},
        {"title": "Quiz 6", "date": "2023/05/20"},
    ]
}
